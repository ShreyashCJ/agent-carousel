...
<body>
    ...
    <script>
        const agents = [
            { index: 0, agent: "Customer Support Agent", name: "Jacob", locale: "en-US", gender: "female", voice: "Amara", avatar: "jacob-avatar.webp", project: "recruiter-agent", agentTags: ["Friendly", "Calm"], talkAbout: "Kind and professional agent assisting with orders, returns, product information, payments, and store details for the retail company KindCommerce.", flagName: "us-canada.svg", flagDisplayName: "English (US)" },
            { index: 5, agent: "Customer Support Agent", name: "Grace", locale: "en-UK", gender: "female", voice: "Ruby", avatar: "grace-avatar.webp", project: "recruiter-agent", agentTags: ["Friendly", "Calm"], talkAbout: "Kind and professional agent assisting with orders, returns, product information, payments, and store details for the retail company KindCommerce.", flagName: "uk.svg", flagDisplayName: "English (UK)" },
            { index: 17, agent: "Customer Support Agent", name: "Kunal", locale: "en-IN", gender: "female", voice: "en-IN-arohi", avatar: "kunal-avatar.webp", project: "recruiter-agent", agentTags: ["Friendly", "Calm"], talkAbout: "Kind and professional agent assisting with orders, returns, product information, payments, and store details for the retail company KindCommerce.", flagName: "india.svg", flagDisplayName: "English (India)" },
            { index: 20, agent: "Customer Support Agent", name: "Harper", locale: "en-AU", gender: "female", voice: "Kylie", avatar: "harper-avatar2.webp", project: "recruiter-agent", agentTags: ["Friendly", "Calm"], talkAbout: "Kind and professional agent assisting with orders, returns, product information, payments, and store details for the retail company KindCommerce.", flagName: "australia.svg", flagDisplayName: "English (Australia)" },
        ];
