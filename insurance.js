...
<body>
    ...
    <script>
        const agents = [
            { index: 0, agent: "Customer Support Agent", name: "Ethan", locale: "en-US", gender: "female", voice: "Amara", avatar: "ethan-avatar.webp", project: "insurance-agent", agentTags: ["Friendly", "Calm"], talkAbout: "Kind and professional agent assisting with orders, returns, product information, payments, and store details for the retail company KindCommerce.", flagName: "us-canada.svg", flagDisplayName: "English (US)" },
            { index: 5, agent: "Customer Support Agent", name: "George", locale: "en-UK", gender: "female", voice: "Ruby", avatar: "george-avatar.webp", project: "insurance-agent", agentTags: ["Friendly", "Calm"], talkAbout: "Kind and professional agent assisting with orders, returns, product information, payments, and store details for the retail company KindCommerce.", flagName: "uk.svg", flagDisplayName: "English (UK)" },
            { index: 17, agent: "Customer Support Agent", name: "Meera", locale: "en-IN", gender: "female", voice: "en-IN-arohi", avatar: "meera-avatar.webp", project: "insurance-agent", agentTags: ["Friendly", "Calm"], talkAbout: "Kind and professional agent assisting with orders, returns, product information, payments, and store details for the retail company KindCommerce.", flagName: "india.svg", flagDisplayName: "English (India)" },
            { index: 20, agent: "Customer Support Agent", name: "Sophie", locale: "en-AU", gender: "female", voice: "Kylie", avatar: "sophie-avatar.webp", project: "insurance-agent", agentTags: ["Friendly", "Calm"], talkAbout: "Kind and professional agent assisting with orders, returns, product information, payments, and store details for the retail company KindCommerce.", flagName: "australia.svg", flagDisplayName: "English (Australia)" },
        ];
